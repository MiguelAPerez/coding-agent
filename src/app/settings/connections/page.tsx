        ...
        <div className="max-w-4xl mx-auto p-8">
            <div className="mb-8 flex justify-between items-center">
                ...
                {!isAdding && (
                    <button 
                        ...
                        className="px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors flex items-center gap-2 font-semibold"
                    >
            ...
            {isAdding && (
                <div className="glass border border-border/50 rounded-2xl p-6 mb-8 animate-in slide-in-from-top-4 duration-300">
                    <h2 className="text-xl font-bold mb-4">New Discord Connection</h2>
