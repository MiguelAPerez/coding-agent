...
import { getAnthropicConfig, saveAnthropicConfig, testAnthropicConnection, syncAnthropicModels, getAnthropicModels, deleteAnthropicConfig } from "@/app/actions/anthropic";
    ...
    useEffect(() => {
        async function loadConfig() {
            try {
                ...
                console.error("Failed to load Claude config", _err);
            } finally {
                setIsLoading(false);
            }
        }
